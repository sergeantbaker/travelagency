...
while($row=mysql_fetch_array($result)){
	...
	<table style="float:left;" id="myTable" class= 'table table-bordered'>
	<tr onclick="location.href='admin.php?content=home&ID=<?php echo $row["ID"]; ?>'">
	<td style="width:15%;"><img src="<?php if (empty($row['Img'])){echo "https://openclipart.org/image/2400px/svg_to_png/194077/Placeholder.png";
